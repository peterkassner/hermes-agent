...
def _memory_provider_init_kwargs(agent, platform) -> Dict[str, Any]:
    ...
    with suppress(Exception):
        ...
        # Memory providers need the real logical workspace, not a product
        # label. runtime_cwd keeps CLI, desktop, gateway, and per-session cwd
        # semantics aligned.
        from agent.runtime_cwd import resolve_agent_cwd
        kwargs["agent_workspace"] = str(resolve_agent_cwd())
    return kwargs
