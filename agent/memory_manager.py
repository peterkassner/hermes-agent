...
class MemoryManager:
    ...
    def _index_provider_tools(self, provider: MemoryProvider) -> None:
        ...
        ``initialize``. Re-indexing after initialization keeps executor routing
        aligned with the schemas subsequently advertised to the model.
        """
    ...
    def initialize_all(self, session_id: str, **kwargs) -> None:
        ...
        self._each_provider("initialize failed", lambda p: p.initialize(session_id=session_id, **kwargs),
                            level=logging.WARNING)
        # Initialized configuration may enable or disable provider tools.
